...
### BEGIN INIT INFO
# Provides:          Voting-Records_unicorn_initialization
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Voting-Records unicorn initialization
...
APP_ROOT=/home/deploy/Voting-Records/current # path to application current folder
