...
private
  ...
  def sort_column
    columns = %w[conferences.start_date agendas.official_law_title agendas.law_description voting_sessions.passed voting_sessions.result1 voting_sessions.result3 voting_sessions.result0 voting_results.vote]
