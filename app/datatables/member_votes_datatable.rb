...
private
  ...
  def sort_column
    columns = %w[conferences.start_date agendas.official_law_title voting_sessions.passed voting_sessions.result1 voting_sessions.result3 voting_sessions.result0 voting_sessions.not_present voting_results.present voting_results.vote]
