...
#          puts "--- checking for duplicates among old versions"
  ...
  #                  puts "---- **** found a repeat among old versions: #{updates[index2].id}"
      ...
      puts "*********************************"
      puts "*********************************"
      puts "** #{version_ids.length} records set for deletion so far; time so far = #{Time.now-start} seconds"
      puts "*********************************"
      puts "*********************************"
      ...
      AllDelegate.find_each do |record|
#        puts "----------------------"
#        puts "----------------------"
#        puts "----------------------"
...
#          puts "--- checking for duplicates among old versions"
  ...
  #                  puts "---- **** found a repeat among old versions: #{updates[index2].id}"
      ...
      # delegates
      ########################
      puts "- testing delegates"
      Delegate.find_each do |record|
#        puts "----------------------"
#        puts "----------------------"
#        puts "----------------------"
#        puts "-- record: #{record.inspect}"
...
#          puts "--- checking for duplicates with current version"
          (updates.length-1).downto(0) do |index|
            begin 
              previous_record = updates[index].reify
  #            puts "--- previous record: #{previous_record.inspect}"
              if record.attributes.except('updated_at') ==
                  previous_record.attributes.except('updated_at')
...
#          puts "--- checking for duplicates among old versions"
  ...
  #                  puts "---- **** found a repeat among old versions: #{updates[index2].id}"
      ...
      # voting results
      ########################
      puts "- testing voting results"
      VotingResult.find_each do |record|
#        puts "----------------------"
#        puts "----------------------"
#        puts "----------------------"
#        puts "-- record: #{record.inspect}"
...
#          puts "--- checking for duplicates among old versions"
  ...
  #                  puts "---- **** found a repeat among old versions: #{updates[index2].id}"
      ...
      # voting sessions
      ########################
      puts "- testing voting sessions"
      VotingSession.find_each do |record|
#        puts "----------------------"
#        puts "----------------------"
#        puts "----------------------"
#        puts "-- record: #{record.inspect}"
